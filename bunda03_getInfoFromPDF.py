...
csv_competency_unit_path = os.path.join(source_folder, 'csv_comp_unit.csv')
...
with open(output_file_path, 'w') as output_file, \
     ...
     open(csv_output_path, 'w', newline='') as csv_output_file, \
     open(csv_competency_unit_path, 'w', newline='') as csv_competency_unit_file:
    ...
    csv_writer.writerow(['Name', 'Qualification Code', 'Filename'])
    csv_comp_unit_writer.writerow(['Name', 'Qualification Code', 'Filename', 'Competency Unit'])    
            ...
            try:
                ...
                if name:
                    ...
                    if qualification_code:
                        print(f"Qualification data: '{qualification_code}'")
                        csv_writer.writerow([name, qualification_code, filename[:-4]])

                    if competency_units:
                        for unit in competency_units:
                            csv_comp_unit_writer.writerow([name, qualification_code, filename[:-4], unit])
